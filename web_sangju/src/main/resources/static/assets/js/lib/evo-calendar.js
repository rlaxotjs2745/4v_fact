...
;(function(factory) {
            ...
            _.initials = {
                ...
                dates: {
                    en: {
                        ...
                        noEventForToday: "방문 신청이 가능하지 않습니다",
                        noEventForThisDay: "방문 신청이 가능하지 않습니다",
                        previousYearText: "Previous year",
                        nextYearText: "Next year",
                        closeSidebarText: "닫기",
                        closeEventListText: "Close"
                    },
                    es: {
            ...
            markup = '<div class="calendar-sidebar">'+
                        ...
                        '<ul class="calendar-months">';
                            ...
                            for(var i = 0; i < _.$label.months.length; i++) {
                                ...
                                markup += '<li class="month" role="button" data-month-val="'+i+'">'+month_kr[i]+'</li>';
                            }
                        markup += '</ul>';
            markup += '</div></div>';
    ...
    EvoCalendar.prototype.buildEventList = function() {
        ...
        var title = new Date(_.$active.date).getMonth() + 1 + '월 ' + new Date(_.$active.date).getDate() +'일';
    ...
    EvoCalendar.prototype.buildCalendar = function() {
        ...
        var count_i=0;
        month_en.forEach(function (element){
            if(title.includes(month_en[count_i])){
                title = month_kr[count_i];
                return false;
            }
            count_i++;
        });
