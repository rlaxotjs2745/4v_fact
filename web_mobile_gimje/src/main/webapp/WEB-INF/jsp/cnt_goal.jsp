        ...
        <div class="page__cnt">
            <div class="goal__container">
                ...
                <div class="goal__campain">
                    <div class="goal__campain--text"><strong>스마트팜 분야 신기술·제품<br>
                        등의 사용화·국산화를 위한<br>
                        거점 구축 및 실증을 통한<br>
                ...
                <div class="goal__diagram">
                    <ul>
                        ...
                        <li>
                            ...
                            <span>실증 전후 필요 기능<br>(정부R&D, 표준화,전시체험, 검정서비스 등) 집적화</span>
                        </li>
                        <li>
                ...
                <div class="cnt__effect">
                    <div class="cnt__effect--item">
                        ...
                        <div class="cnt__effect--text">스마트팜 실증 및 제품 고도화, 홍보마케팅 등 지원을 통한 스마트팜 기술의 국산화 제고 및 상용화 가속화에 기여</div>
                        <ul class="cnt__effect--list">
                            <li>제품 상용화 시 발생 가능한 위험 부담을 최소화하여 비용과 시간을 절감</li>
                            <li>스마트팜 분야 국내 기술수준 정밀진단 및 선진국과의 기술 격차 완화</li>
                        </ul>
                    </div>
                    <div class="cnt__effect--item">
                        <span class="cnt__effect--num">02 <em>둘</em></span>
                        <div class="cnt__effect--text">국내 스마트팜 기술의 검증을 기반으로 농가 신뢰성 향상을 통한 선순한 구조체계 구축 및 기업의 글로벌 경쟁력 강화를 통해 세계 스마트팜 시장 선도</div>
                        <ul class="cnt__effect--list">
                    ...
                    <div class="cnt__effect--item">
                        ...
                        <ul class="cnt__effect--list">
                            <li>국내 스마트팜 기술 검증을 통한 이미지 부각으로 국내 및 해외시장에 우수성 홍보 효과</li>
                        </ul>
                    </div>
                    <div class="cnt__effect--item">
