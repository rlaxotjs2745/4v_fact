! function(t, e) {
    ...
    813: function(t, e, s) {
        ...
        var m = ["rtl", "style", "layoutPosition", "layoutNavbarFixed", "layoutFooterFixed", "layoutReversed", "navbarBg", "sidenavBg", "footerBg", "themes"],
            ...
            y = function() {
                ...
                return e = t, (s = [{
                    ...
                    value: function(t) {
                        ...
                        if (this._hasControls("themes")) {
                            ...
                            if (i) {
                                ...
                                this._loadStylesheets(u({}, n, document.querySelector(".theme-settings-theme-css")), s || function() {}), e && this.settings.onSettingsChange.call(this, this.settings)
                            }
                        }
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        this._cleanup(), this.container = this._getElementFromString(l.a);
                        ...
                        var n = this.container.querySelector(".theme-settings-close-btn"),
                            a = function() {
                        ...
                        if (this._hasControls("rtl")) {
                            ...
                            o.addEventListener("change", c), this._listeners.push([o, "change", c])
                        ...
                        if (this._hasControls("layoutPosition layoutNavbarFixed layoutFooterFixed layoutReversed", !0)) {
                            ...
                            if (this._hasControls("layoutPosition")) {
                                ...
                                this._controls.layoutPosition.addEventListener("change", y), this._listeners.push([this._controls.layoutPosition, "change", y])
                            ...
                            if (this._controls.layoutFooterFixedW = this.container.querySelector(".theme-settings-layoutFooterFixed"), this._hasControls("layoutFooterFixed")) {
                                ...
                                this._controls.layoutFooterFixed.addEventListener("change", p), this._listeners.push([this._controls.layoutFooterFixed, "change", p])
