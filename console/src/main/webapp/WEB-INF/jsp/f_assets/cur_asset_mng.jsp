                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="w-lg-100 ml-3">
                                <div class=" d-flex justify-content-between">
                                    ...
                                    <div class="text-big font-weight-semibold">22</div>
                                </div>
                                <div class=" d-flex justify-content-between">
                                    <div class="text-muted small mt-1">위탁</div>
                                    <div class="text-big font-weight-semibold">5</div>
                                </div>
                                <div class=" d-flex justify-content-between">
                                    <div class="text-muted small mt-1">자율</div>
                                    <div class="text-big font-weight-semibold">17</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="w-lg-100 ml-3">
                                <div class=" d-flex justify-content-between">
                                    ...
                                    <div class="text-big font-weight-semibold">19</div>
                                </div>
                                <div class=" d-flex justify-content-between">
                                    <div class="text-muted small mt-1">위탁</div>
                                    <div class="text-big font-weight-semibold">5</div>
                                ...
                                <div class=" d-flex justify-content-between">
                                    <div class="text-muted small mt-1">자율</div>
                                    <div class="text-big font-weight-semibold">14</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="w-lg-100 ml-3">
                                <div class=" d-flex justify-content-between">
                                    ...
                                    <div class="text-big font-weight-semibold">11</div>
                                </div>
                                <div class=" d-flex justify-content-between">
                                    <div class="text-muted small mt-1">예약</div>
                                    <div class="text-big font-weight-semibold">2</div>
                                </div>
                                <div class=" d-flex justify-content-between">
                                    <div class="text-muted small mt-1">대기</div>
                                    <div class="text-big font-weight-semibold">9</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="w-lg-100 ml-3">
                                <div class=" d-flex justify-content-between">
                                    ...
                                    <div class="text-big font-weight-semibold">0</div>
                                </div>
                                <div class=" d-flex justify-content-between">
                                    <div class="text-muted small mt-1">위탁</div>
                                    <div class="text-big font-weight-semibold">0</div>
                ...
                <div class="card mb-3">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="w-lg-100 ml-3">
                                <div class=" d-flex justify-content-between">
                                    <div class="text-muted small mt-1">플랜트</div>
                                    <div class="text-big font-weight-semibold">4</div>
                                </div>
                                <div class=" d-flex justify-content-between">
                                    <div class="text-muted small mt-1">위탁</div>
                                    <div class="text-big font-weight-semibold">1</div>
                                </div>
                                <div class=" d-flex justify-content-between">
                                    <div class="text-muted small mt-1">자율</div>
                                    <div class="text-big font-weight-semibold">3</div>
                                </div>
                            </div>
                        </div>
                    </div>
