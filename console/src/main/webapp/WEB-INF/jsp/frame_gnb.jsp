            ...
            <div class="navbar-nav align-items-lg-center ml-auto">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <div class="list-group list-group-flush">
                            <a href="javascript:void(0)" class="list-group-item list-group-item-action media d-flex align-items-center">
                                <img src="<%=request.getContextPath()%>/static/assets/img/avatars/6-small.png" class="d-block ui-w-40 rounded-circle" alt>
                            ...
                            <a href="javascript:void(0)" class="list-group-item list-group-item-action media d-flex align-items-center">
                                <img src="<%=request.getContextPath()%>/static/assets/img/avatars/4-small.png" class="d-block ui-w-40 rounded-circle" alt>
                                <div class="media-body ml-3">
                            ...
                            <a href="javascript:void(0)" class="list-group-item list-group-item-action media d-flex align-items-center">
                                <img src="<%=request.getContextPath()%>/static/assets/img/avatars/5-small.png" class="d-block ui-w-40 rounded-circle" alt>
                                <div class="media-body ml-3">
                            ...
                            <a href="javascript:void(0)" class="list-group-item list-group-item-action media d-flex align-items-center">
                                <img src="<%=request.getContextPath()%>/static/assets/img/avatars/11-small.png" class="d-block ui-w-40 rounded-circle" alt>
                                <div class="media-body ml-3">
                ...
                <div class="demo-navbar-user nav-item dropdown">
                  ...
                  <span class="d-inline-flex flex-lg-row-reverse align-items-center align-middle">
                    <img src="<%=request.getContextPath()%>/static/assets/img/avatars/1.png" alt class="d-block ui-w-30 rounded-circle">
