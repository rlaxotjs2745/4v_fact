...
<div class="container-fluid flex-grow-1 container-p-y">
    <h4 class="font-weight-bold py-3 mb-4">콘솔 관리자 관리</h4>
        ...
        <div class="modal-dialog modal-lg">
            <form class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">콘솔 관리자 등록</h5>
                    ...
                    <div class="form-row">
                        <div class="form-group col col-md-12">
                            <table class="table table-bordered no-footer m-0" role="grid" aria-describedby="article-list_info" style="">
                                <tbody>
                                    <tr class="">
                                        <th class="text-center bg-light" style="width:16%">이름</th>
                                        <td class="text-center" style="width:34%" id="admin_name_detail">홍길동</td>
                                        <th class="text-center bg-light" style="width:16%">휴대폰 번호</th>
                                        <td class="text-center" style="width:34%" id="mphone_num_detail">000-0000-0000</td>
                                    </tr>
                            ...
                            <table class="table table-bordered no-footer m-0" role="grid" aria-describedby="article-list_info">
                                <tbody>
                                <tr>
                                    <th class="text-center bg-light" style="width:16%">이메일 주소</th>
                                    <td class="text-center" style="width:34%" id="web_id_detail">dongdong</td>
                                    <th class="text-center bg-light" style="width:16%" >시스템권한</th>
                                    <td class="" colspan="4" style="width:34%" id="admin_type_detail">단지책임자</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="modal-footer justify-content-end">
                    <div>
                        <button id="btn_add_console_admin" type="button" class="btn btn-default">등록</button>
...
<script>
    ...
    $("#btn_add_console_admin").click(function(){
        if(confirm($("#admin_name_modify").val() + "님을 콘솔 관리자로 등록하시겠습니까?")){

            $.ajax({
                type: 'post',
                url: 'add_console_admin',
