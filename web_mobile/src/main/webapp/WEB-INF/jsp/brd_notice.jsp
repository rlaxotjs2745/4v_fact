        ...
        <div class="page__cnt">
            ...
            <div class="table__type">
                <table class="table__type--board ">
                    ...
                    <tr>
                        <td>670</td>
                        <td class="td__left"><a href="brd_notice_detail" class="td__link">종자생명산업 맞춤형 인력양성」 교육훈련생 선정 결과 알림<img src="<%=request.getContextPath()%>/static/assets/image/ico_new.png" alt="NEW" class="board__badge"></a></td>
