    ...
    <div class="page__full">
      <div class="page__floating">
        <div class="tb__logo"><img src="<%=request.getContextPath()%>/static/assets/image/img_loginLogo@3x.png" alt="">
          <a href="login" class="btn-close"><img src="<%=request.getContextPath()%>/static/assets/image/ico_close.png" alt="취소"></a>
        </div>
        ...
        <div class="tb__join">
          <div class="td__cell">
            <div class="join__board">
              ...
              <span class="join__page">기본정보</span>
            </div>
            <div class="join__field">
              <div class="table__type">
                <table class="table__type--my table__fixed">
                  ...
                  <tr>
                    <td class="td__form">
                      <div class="th__block">기업(단체)명<span class="text__essential">*</span></div>
                      <input type="text" placeholder="기업(단체)명을 입력"></td>
                  </tr>
                  <tr>
                    <td class="td__form">
                  ...
                  <tr>
                    <td class="td__form">
                      <div class="th__block">사업자등록번호<span class="text__essential">*</span></div>
                      <input type="tel" style="width:80px;"><span class="text__dash">-</span><input type="tel" style="width:80px;"><span class="text__dash">-</span><input type="tel" style="width:80px;"></td>
                  </tr>
                  <tr>
                    <td class="td__form">
                      <div class="th__block">대표자명<span class="text__essential">*</span></div>
                      <input type="text" placeholder="대표자명 입력"></td>
                  </tr>
                  <tr>
                    <td class="td__form">
                      <div class="th__block">업태/종목<span class="text__essential">*</span></div>
                      <input type="text" placeholder="업태" style="width:45%"><span class="text__dash">/</span><input type="text" placeholder="종목" style="width:45%"></td>
                  </tr>
                  <tr>
                    <td class="td__form">
                      <div class="th__block">주소</div>
                      <input type="text" placeholder="우편번호" style="width:100px;"> <span class="text__zipcode"><a href="#" class="btn modify btn-lg">주소검색</a></span>
                  ...
                  <tr>
                    <td class="td__form">
                      ...
                      <span class="text__lock">https://</span><input type="text" placeholder="홈페이지 주소 입력" style="width:calc(100% - 60px)"></td>
                  </tr>
                  <tr>
                    <td class="td__form">
                      <div class="th__block">회사전화번호<span class="text__essential">*</span></div>
                      <input type="text" placeholder="000-0000-0000"></td>
                  </tr>
                  <tr>
                    <td class="td__form">
                ...
                <table class="table__type--my table__fixed">
                  ...
                  <tr>
                    <td class="td__form">
                      ...
                      <input type="text" style="margin-bottom: 5px;" /><span class="text__dash">@</span><input type="tel" style="width:calc(100% - 160px);" />
                      <select name="" id="">
                      ...
                      <span class="text__check">확인 메일 및 결과를 메일로 알려드립니다. <br>정확히 입력해주세요.</span>
                    </td>
                  </tr>
                  <tr>
                    <td class="td__form">
              ...
              <div class="table__type">
                <table class="table__type--my table__fixed">
                  ...
                  <tr>
                    <td>꿈꾸는농장</td>
                    <td>000-00-0000</td>
                    <td class="td__form">홍길동 <span class="text__dash"><a href="#" class="btn modify submit btn-lg">선택</a></span></td>
                  </tr>
                  <tr>
                    <td>꿈꾸는농장</td>
                    <td>000-00-0000</td>
