            ...
            <div class="step__desc">
                ...
                <div class="step__autonomous">
                    <div class="step__autonomous--box box--01">
                        ...
                        <ul>
                            <li>(재단) 실증항목(과제, 기술분야, 실증기간 등) 상담</li>
                            <li>(재단, 의뢰인) 필요항목(부지, 온실, 장비 등) 설정</li>
                            <li>(재단) 공동운영비(폐작물 처리, 공동방제, 재배사 등)<br>사전 안내</li>
                            <li>(재단, 의뢰인) 임대계약 체결</li>
                        </ul>
                    </div>
                    <div class="step__autonomous--box box--02">
                        <strong>STEP 02</strong>
                        <ul>
                            <li>(재단, 의뢰인) 부지, 온실, 실증장비 등 임대 및 활용</li>
                    ...
                    <div class="step__autonomous--box box--03">
                        ...
                        <ul>
                            ...
                            <li>(재단) 실증연계서비스<br>(전시·체험, 표준화, 검인증 등) 안내</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="step__autonomous--02">
                    <div class="step__autonomous--box box--01">
                        ...
                        <ul>
                            ...
                            <li>(재단, 의뢰인) 실증진행방향(예상결과 등)<br>및 서비스료 협의</li>
                            <li>(재단, 의뢰인) 공공실증계약 체결</li>
                        </ul>
                    </div>
                    <div class="step__autonomous--box box--02">
                        <strong>STEP 02</strong>
