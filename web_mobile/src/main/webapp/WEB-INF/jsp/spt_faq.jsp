        ...
        <div class="page__cnt">
            <div class="spt__container">
                <div class="faq__banner">
                    <div class="faq__banner--title">자주 묻는 질문<br>TOP7</div>
                </div>
                ...
                <div class="faq__list">
                    <dl>
                        ...
                        <dd class="is-fold">한국농업기술진흥원에서는 농림축산식품 기술사업화 종합정보망(NATI)를 통해 농식품 분야 최신 특허정보(실용신안 포함)를 제공하고있습니다.
                            ...
                            ★ 문 의 : 농업기술진흥원 기술창출이전팀 분야별 담당자
                            - 기능성,곤충, 원예/  비국유특허 중개(지자체, 대학, 민간 등): 김찬주(cjkim@koat.or.kr, 063-919-1311)
                            - 식품, 식량 : 백정선(jsbaek@koat.or.kr, 063-919-1319)
                            - 스마트팜, 농기계, 농자재: 김준기(jkkim100@koat.or.kr, 063-919-1322)
                            - 축 산 : 노재성(no062420@koat.or.kr, 063-919-1321)</dd>
