        ...
        <div class="page__cnt">
            ...
            <div class="table__type no--head">
                ...
                <div class="detail__nav">
                    <a href="brd_event_detail?idx=${eventContent.idx_event_content-1}" class="detail__anchor anchor--back">
                        <img src="resources/assets/image/ico_back.png" alt="이전글"> 이전글
                    </a>
                    <a href="brd_event_detail?idx=${eventContent.idx_event_content+1}" class="detail__anchor anchor__foword">
