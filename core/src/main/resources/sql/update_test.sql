...
ALTER TABLE TB_FARM RENAME COLUMN YMDTIME TO YMDTIME_DT;
...
ALTER TABLE TB_USER_DEMO_BS ADD IS_USE_AGREE	NUMBER(4) DEFAULT 0;
ALTER TABLE TB_USER_DEMO_BS ADD IS_INDI_USE_AGREE	NUMBER(4) DEFAULT 0;
ALTER TABLE TB_USER_DEMO_BS ADD IS_INDI_INFO_AGREE	NUMBER(4) DEFAULT 0;
...
ALTER TABLE TB_DEMO_BUSINESS ADD EXAM_START	DATE;
ALTER TABLE TB_DEMO_BUSINESS ADD EXAM_END	DATE;
ALTER TABLE TB_DEMO_BUSINESS ADD PLAN_REVIEW_START	DATE;
ALTER TABLE TB_DEMO_BUSINESS ADD PLAN_REVIEW_END	DATE;
ALTER TABLE TB_DEMO_BUSINESS ADD CONVENTION_START	DATE;
ALTER TABLE TB_DEMO_BUSINESS ADD CONVENTION_END	DATE;

ALTER TABLE TB_DEMO_BS_APPLICAION ADD IDX_USER_DEMO_BS NUMBER(32);
...
ALTER TABLE TB_SMS_TEMPLATE ADD MEMO	VARCHAR2	(1000);

DROP TABLE TB_SMS_TEMPLATE;
DROP TABLE TB_EMAIL_TEMPLATE;

ALTER TABLE TB_SMS_TEMPLATE ADD IS_GROUP NUMBER(4) DEFAULT 0;


ALTER TABLE TB_FARM_SECTOR RENAME COLUMN IDX_USER_DEMOBS TO IDX_USER_DEMO_BS;

ALTER TABLE TB_EMAIL RENAME COLUMN IDX_EMAIL_TEMPLATE TO IDX_EMAIL_TEMPLATE;