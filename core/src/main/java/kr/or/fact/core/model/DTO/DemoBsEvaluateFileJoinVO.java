...
@Data
public class DemoBsEvaluateFileJoinVO {

    long idx_demo_bs_evaluate_file_join;//	number	32			◯		인덱스	auto increase
    long idx_demo_bs_applicaion;//	number	32				◯	지원번호
    long idx_demo_business;//	number	32				◯	지원사업
    long idx_demo_bs_applicaion_evaluate;//	number	32				◯	평가
    int file_type;//	number	4		0			파일 타입	0:평가서, 1:종합의견서
