...
@Data
public class DemoBsContractFileJoinVO {

    long idx_demo_bs_contract_file_join;//	number	32			◯		인덱스	auto increase
    long idx_demo_bs_applicaion;//	number	32				◯	지원번호
    long idx_demo_business;//	number	32				◯	지원사업
    long idx_demo_bs_contract;//	number	32				◯	협약
    int file_type;//	number	4		0			파일 타입	0:협약서
