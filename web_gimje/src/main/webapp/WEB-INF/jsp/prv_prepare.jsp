            ...
            <div class="fee__container">
                ...
                <div class="exam__layout">
                    ...
                    <div class="exam__note">
                        ...
                        <ol>
                            <li>「농촌진흥법」에 정한 농업ᆞ농업인ᆞ농촌과 관련된 과학기술의 연구개발ᆞ보급, 농촌지도, 교육훈련<br>
                                <p style="text-indent:1em">및 국제협력에 관한 업무를 수행하는 농업진흥기관</p></li>
                            <li>「중소기업기본법」상 중소기업에 해당하는 기업</li>
                            <li>중견기업 이상의 경우 실증시설을 이용하는 다른 실증단지이용자를 선도 또는 지원할 수 있는 기업</li>
                            <li>국내의 기관이나 단체 또는 사업자와 공동으로 연구개발 및 기술이전을 주목적 으로 설립한 <br>
                                <p style="text-indent:1em">외국연구기관</p></li>
                            <li>「특정연구기관 육성법」의 적용을 받는 연구기관</li>
                            <li>「정부출연연구기관 등의 설립·운영 및 육성에 관한 법률」에 따라 설립된 정부출연연구기관 또는<br>
                                <p style="text-indent:1em">「과학기술분야 정부출연연구기관 등의 설립·운영 및 육성에 관한 법률」에 따라 설립된 과학기술분야</p>
                                <p style="text-indent:1em">정부출연연구기관</p></li>
                            <li>「기초연구진흥 및 기술개발지원에 관한 법률」제14조제1항제2호에 따른 기업 부설연구소 중 <br>
                                <p style="text-indent:1em">스마트팜 관련 기업부설연구소 보유기업</p></li>
