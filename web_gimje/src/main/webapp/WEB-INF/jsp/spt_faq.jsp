        ...
        <div class="page__menu--box">
            <div class="page__menu--inner">
                ...
                <div class="page__location">
                    <div class="location__deco">농업기술실용화재단 홈페이지에서 자주 문의하시는 질문을 모았습니다.</div>
                </div>
            </div>
        </div>
        <div class="page__cnt">
            <div class="spt__container">
                ...
                <div class="faq__list">
                    <dl>
                        ...
                        <dd class="is-fold">농업기술실용화재단에서는 농림축산식품 기술사업화 종합정보망(NATI)를 통해 농식품 분야 최신 특허정보(실용신안 포함)를 제공하고있습니다.
                        ...
                        <dd class="is-fold">★ 문 의 : 농업기술실용화재단 기술창출이전팀 분야별 담당자
                            - 기능성,곤충, 원예/  비국유특허 중개(지자체, 대학, 민간 등): 김찬주(cjkim@efact.or.kr, 063-919-1311)
                            - 식품, 식량 : 백정선(jsbaek@efact.or.kr, 063-919-1319)
                            - 스마트팜, 농기계, 농자재: 김준기(jkkim100@efact.or.kr, 063-919-1322)
                            - 축 산 : 노재성(no062420@efact.or.kr, 063-919-1321)</dd>
                ...
                <div class="faq__notice">
                    <img src="<%=request.getContextPath()%>/static/assets/image/img_faq_notice_02.png" alt="서로를 존중하는 말로 상담 부탁드립니다. 농업기술실용화재단 고객지원센터는 산업안전보건법에 따라 상담원 보호조치를 시행 중입니다.">
