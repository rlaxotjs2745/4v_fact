...
<c:forEach items="${noticeList}" var="notice" varStatus="status">
                ...
                <div class="table__paging">
                    ...
                    <c:if test="${is_past eq true}"><a href="brd_notice?page=1" class="paging__prev2"><img src="<%=request.getContextPath()%>/static/assets/image/ico_paging_prev_02.png" alt=""></a></c:if>
                    <c:if test="${is_prev eq true}"><a href="brd_notice?page=${cur_page-1}" class="paging__prev"><img src="<%=request.getContextPath()%>/static/assets/image/ico_paging_prev.png" alt=""></a></c:if>
                    ...
                    <c:if test="${is_next eq true}"><a href="brd_notice?page=${cur_page+1}" class="paging__next"><img src="<%=request.getContextPath()%>/static/assets/image/ico_paging_next.png" alt=""></a></c:if>
                    <c:if test="${is_last eq true}"><a href="brd_notice?page=${tot_page}" class="paging__next2"><img src="<%=request.getContextPath()%>/static/assets/image/ico_paging_next_02.png" alt=""></a></c:if>
                </div>
            </div>
            <!--//-->
        </div>
