                    ...
                    <div class="td__cell">
                        ...
                        <div class="join__field">
                            <div class="join__range">
                                <a href="join" class="join__range--type is-active">개인회원 등록</a>
                                <a href="join_2" class="join__range--type ">기업/단체 회원 등록</a>
                            </div>
                            <div class="join__text">
                                실증서비스 사업 참여시, 개인회원 및 기업/단체 모두 가능합니다.<br>
    ...
    <script>
        ...
        $("#btn_next").on("click", function() {
            ...
            if(is_checked){
                ...
                window.location.href='join_person?service_agree=1&privacy_agree=1&third_party_agree=1';
            }
            else {
