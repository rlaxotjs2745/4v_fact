            ...
            <div class="table__type no--head">
                ...
                <div class="detail__nav">
                    <a href="#none" class="detail__anchor anchor--back">
                        <img src="<%=request.getContextPath()%>/static/assets/image/ico_back.png" alt="이전글"> 이전글 <span>농업기술실용화재단 공고 제2021-121호</span>
                    </a>
                    <a href="#none" class="detail__anchor anchor__foword">
                        <span>농업기술실용화재단 공고 제2021-121호</span> 다음글 <img src="<%=request.getContextPath()%>/static/assets/image/ico_foword.png" alt="다음글">
                    </a>
