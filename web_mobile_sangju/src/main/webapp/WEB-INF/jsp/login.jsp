            ...
            <div class="page__floating">
                ...
                <div class="tb__login">
                    <div class="login__field">
                        <div class="login__logo"><img src="<%=request.getContextPath()%>/static/assets/image/img_loginLogo@3x.png" alt=""></div>
                        ...
                        <div class="login__checkbox">
                            <div class="checkbox">
                                <input type="checkbox" id="login-1" name="logingroup">
                                <label for="login-1">아이디 저장</label>
                            </div>
                            <div class="checkbox">
                                <input type="checkbox" id="login-2" name="logingroup">
