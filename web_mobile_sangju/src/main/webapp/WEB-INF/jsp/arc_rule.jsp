            ...
            <div class="table__type ">
                <table class="table__type--board">
                    ...
                    <tr>
                        ...
                        <td class="td__list">
                            <ul>
                                <li>총칙, 운영위원회, 실증단지운영 및 사업, 실증단지이용자 선정 및 관리</li>
                                <li>사용수익 및 시설관리, 분쟁해결 및 민원처리, 관리감독 및 보고 </li>
                            </ul>
                        </td>
                        <td class="">파솔라시도부서</td>
                        <td class="td__data"></td>
                    </tr>
                    <tr>
                        <td class="td__dic">실증단지이용자 관리 편람 </td>
                        <td class="td__list">
                            <ul>
                                <li>총칙, 이용신청, 실증단지 사용승인, 계약 및 이용료, 시설사용 </li>
                                <li>사고 및 변상, 이용기간 연장 및 퇴거, 기타(성과조사 등) </li>
                            </ul>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="td__list">
                            <ul>
                                <li>총칙, 시설물이용 및 관리, 자산관리, CCTV 설치 및 운영 </li>
                                <li>공용(공동)제작실, 지원시설, 실증시설 </li>
                            </ul>
                        </td>
                        <td class="">솔솔미미레부서</td>
                    ...
                    <tr>
                        ...
                        <td class="td__list">
                            <ul>
                                <li>총칙, 장비심의위원회, 도입, 관리 및 활용, 운용관리, 유지보수 및 처분 </li>
                            </ul>
                        </td>
                        <td class="">도미솔도미솔부서</td>
                        <td class="td__data"><a href="#none"><img src="<%=request.getContextPath()%>/static/assets/image/ico_pdf.png" alt=""></a></td>
