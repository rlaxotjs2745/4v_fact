...
(function () {
  ...
  $(document.body).on('focus', '.common__search--input input', function (e) {
    e.preventDefault();
    $(".search__word--lists").slideDown();
    $(".btn-search-cancel").removeClass("d-none");
  });
  $(document.body).on('click', '.btn-search-cancel', function (e) {
    e.preventDefault();
    $(".search__word--lists").slideUp();
    $(this).addClass("d-none");
  }); //scroll top btn

  $(function () {
    //$('.container').append('<div class="gotop"><a href="#skipnav"><img src="../../images/webhome/gotop.png" alt="??? ???????"></a></div>');
    var $gotop = $('.content .btn_top');
  ...
  $(document).on('click', '.nav .btn-close-menu', function (e) {
    e.preventDefault();
    $(".nav").removeClass("is-expanded");
  }); //nav

  $(".nav--depth2").hide();
  $(document).on('click', '.nav--depth1 > li > a', function () {
    //e.preventDefault();
    console.log("d1");
    $(".nav--depth1").removeClass("is-active");
    $(".nav--depth2").hide();
  ...
  $(document).on('click', '.news__badge', function (e) {
    e.preventDefault();
    var targetName = $($(this).attr("href"));
    $(".news__badge").removeClass("is-active");
    $(this).addClass("is-active");
    $(".main__news--notice").removeClass("is-active");
    targetName.addClass("is-active");
  }); //breadcrumbs--box
