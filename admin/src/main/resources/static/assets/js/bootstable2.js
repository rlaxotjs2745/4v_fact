...
//Acepta los cambios de la edición
    ...
    let param = {
        idx_system_code:$row.attr('data-idx'), //idx 값
        code_name:$cols[1].textContent,
        code_value:$cols[2].textContent,
    ...
    $.ajax({
        type: 'post',
        url :'update_system_code\t', //데이터를 주고받을 파일 주소 입력
...
function rowElim(but) {  //Elimina la fila actual
    ...
    $.ajax({
        type: 'post',
        url :'delete_system_code', //데이터를 주고받을 파일 주소 입력
        data: JSON.stringify(param),//보내는 데이터
        contentType:"application/json; charset=utf-8;",//보내는 데이터 타입
        dataType:'json',//받는 데이터 타입
        success: function(result){
