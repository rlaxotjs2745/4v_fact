...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <button class="btn btn-white">
                    <div class="d-flex align-items-center" onclick="pageLoad('c10_site_mng_consult_mng',{page_num:1},'자산현황');">
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card mb-3">
                <button class="btn btn-white">
                    <div class="d-flex align-items-center" onclick="pageLoad('c21_site_visit_list',{page_num:1},'상담');">
            ...
            <div class="card mb-3" style="min-height: 550px">
                ...
                <div class="card-header font-weight-bold with-elements text-white bg-success">
                    ...
                    <div class="card-header-elements ml-auto">
                        <button type="button" class="btn btn-default btn-xs btn-outline-white" onclick="pageLoad('b21_demo_bs_appl_mng',{page_num:1},'신규신청 접수');">Show more</button>
                    </div>
                </div>
...
<%--        <div class="main col-md-6 col-lg-12 col-xl-6" id="dashboard_calendar_view" onclick="pageLoad('c22_site_visit_mng','1:1문의');">
            <%@ include file="../c_site_mng/c22_site_visit_mng.jsp"%>
