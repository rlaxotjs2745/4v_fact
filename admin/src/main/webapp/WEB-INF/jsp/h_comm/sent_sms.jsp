...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <h5 class="d-flex justify-content-between align-items-center w-100 mt-2">
        <div><i class="pe-7s-way text-success-custom"></i>&nbsp;&nbsp;완료된 SMS</div>
    </h5>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table id="table_demo_bs" class="table table-striped table-bordered dataTable no-footer mt-0" role="grid" aria-describedby="article-list_info" style="">
                            ...
                            <tr role="row">
                                <th class="text-center px-2" style="width:8%">Job ID</th>
                                ...
                                <th class="text-center px-2" style="width:10%">발송시간</th>
                                <th class="text-center px-2" style="width:38%">문자메세지 내용</th>
                                <th class="text-center px-2" style="width:6%">요청 수</th>
                                <th class="text-center px-2" style="width:6%">전송 성공</th>
                                <th class="text-center px-2" style="width:6%">전송 실패</th>
                            </tr>
                            </thead>
                            <tbody>
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <c:forEach items="${smsItemVOList}" var="item" varStatus="status">
                                        <tr class="reserveSms-entity" id="${item.msg_id}">
                                            ...
                                            <td class="text-center">${item.job_id}</td>
                                            ...
                                            <td class="text-center">${item.dest_count}</td>

                                            <td class="text-center">${item.succ_count}</td>

                                            <td class="text-center">${item.fail_count}</td>
                                        </tr>
