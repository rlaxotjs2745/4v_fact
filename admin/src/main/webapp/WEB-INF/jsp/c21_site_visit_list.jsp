...
<%--                            <input type="radio" name="btn-radio" class="category_change" id="all" onclick="javascript:pageLoad('c21_site_visit_listpage=1&filter1=9999&filter2=9998','견학신청 목록');">전체--%>
                            <input type="radio" name="btn-radio" class="category_change <c:if test="${filter1==9999}">active</c:if>" id="all" onclick="javascript:pageLoad('c21_site_visit_list',{page_num:1,filter1:9999,filter2:9998},'견학신청 목록');">전체
                        </label>
                        <label class="btn btn-secondary">
                            <input type="radio" name="btn-radio" class="category_change <c:if test="${filter1==0}">active</c:if>" id="new" value="0"  onclick="javascript:pageLoad('c21_site_visit_list',{page_num:1,filter1:0,filter2:9998},'견학신청 목록');"> 신규
                        </label>
                        <label class="btn btn-secondary ">
                            <input type="radio" name="btn-radio" class="category_change <c:if test="${filter1==1}">active</c:if>" id="register" value="1" onclick="javascript:pageLoad('c21_site_visit_list',{page_num:1,filter1:1,filter2:9998},'견학신청 목록');" > 접수
                        </label>
                        <label class="btn btn-secondary ">
                            <input type="radio" name="btn-radio" class="category_change <c:if test="${filter1==2}">active</c:if>" id="approval" value="2" onclick="javascript:pageLoad('c21_site_visit_list',{page_num:1,filter1:2,filter2:9998},'견학신청 목록');" > 승인
                        </label>
                        <label class="btn btn-secondary ">
                            <input type="radio" name="btn-radio" class="category_change <c:if test="${filter1==3}">active</c:if>" id="visit" value="3" onclick="javascript:pageLoad('c21_site_visit_list',{page_num:1,filter1:3,filter2:9998},'견학신청 목록');" > 방문
                        </label>
                        <label class="btn btn-secondary ">
                            <input type="radio" name="btn-radio" class="category_change <c:if test="${filter1==4}">active</c:if>" id="visited" value="4" onclick="javascript:pageLoad('c21_site_visit_list',{page_num:1,filter1:4,filter2:9998},'견학신청 목록');" > 방문완료
                        </label>
                        <label class="btn btn-secondary ">
                            <input type="radio" name="btn-radio" class="category_change <c:if test="${filter1==5}">active</c:if>" id="cancle" value="5" onclick="javascript:pageLoad('c21_site_visit_list',{page_num:1,filter1:5,filter2:9998},'견학신청 목록');" > 방문취소
                        </label>
                        <label class="btn btn-secondary ">
                            <input type="radio" name="btn-radio" class="category_change <c:if test="${filter1==6}">active</c:if>" id="refuse" value="6" onclick="javascript:pageLoad('c21_site_visit_list',{page_num:1,filter1:6,filter2:9998},'견학신청 목록');" > 승인거절
                        </label>
                    </div>
                </div>
            </div>
...
<%--                    <hr class="mt-0">--%>
                    ...
                    <div class="form-row">
                        <div class="form-group col col-md-12 mb-0">
                            ...
                            <label class="custom-control custom-radio d-inline-block">
                                <input name="custom-7" type="radio" class="custom-control-input" checked>
...
// let result = document.getElementsByName('custom-6');
        ...
        console.log($("input:radio[name=custom-6]:checked").val());
        console.log($("#update_date").val()+"T"+$("#flatpickr-time-start").val());
