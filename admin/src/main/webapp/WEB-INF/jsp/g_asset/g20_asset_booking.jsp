...
<%--    </div>--%>
    ...
    <div class="card px-4 pt-4 pb-4" style="margin-bottom: 0.3em">
            ...
            <div class="form-inline">
                <div class="btn-group btn-group-sm btn-group-toggle" data-toggle="buttons">
                    <label class="btn btn-secondary active">
                        <input type="radio" name="btn-radio-status" value="100" checked>전체
                    </label>
                    <label class="btn btn-secondary">
                        <input type="radio" name="btn-radio-status" value="1"> 승인
                    </label>
                    <label class="btn btn-secondary">
                        <input type="radio" name="btn-radio-status" value="99"> 승인 불가
                    </label>
                    <label class="btn btn-secondary">
                        <input type="radio" name="btn-radio-status" value="3"> 부분 승인
                    </label>
                    <label class="btn btn-secondary">
                        <input type="radio" name="btn-radio-status" value="4"> 사용 거절
                    </label>
                    <label class="btn btn-secondary">
        ...
        <%--                        <div class="btn-group btn-group-sm btn-group-toggle" data-toggle="buttons">--%>
        <%--                            <label class="btn btn-secondary active">--%>
        <%--                                <input type="radio" name="btn-radio-status" checked="">오늘--%>
        <%--                            </label>--%>
        <%--                            <label class="btn btn-secondary">--%>
        <%--                                <input type="radio" name="btn-radio-status"> 1주일--%>
        <%--                            </label>--%>
        <%--                            <label class="btn btn-secondary">--%>
        <%--                                <input type="radio" name="btn-radio-status"> 1개월--%>
        <%--                            </label>--%>
        <%--                            <label class="btn btn-secondary">--%>
        <%--                                <input type="radio" name="btn-radio-status"> 3개월--%>
        <%--                            </label>--%>
        <%--                            <label class="btn btn-secondary">--%>
        <%--                                <input type="radio" name="btn-radio-status"> 6개월--%>
        <%--                            </label>--%>
        <%--                            <label class="btn btn-secondary">--%>
        <%--                                <input type="radio" name="btn-radio-status"> 1년이상--%>
        <%--                            </label>--%>
        <%--                        </div>--%>
        <%--                    </div>--%>
        <%--                </div>--%>
            ...
            <div class="modal-body pb-2">
                ...
                <div class="form-row">
                    <div class="form-group col col-md-12">
                        ...
                        <div class="form-inline mb-2">
                            ...
                            <select class="custom-select mr-sm-2 mb-2 mb-sm-0" id="asset_sub_code" value="0"
                                    style="display: none">
                                <option value="0" selected>중분류 전체</option>
                            </select>
                            <select class="custom-select mr-sm-2 mb-2 mb-sm-0" id="asset_detail_code" value="0"
                                    style="display: none">
                ...
                <div class="form-row">
                    <div class="form-group col col-md-12">
                        ...
                        <textarea class="form-control" id="asset_usage" rows="3"
                                  placeholder="1000자 이내로 작성이 가능합니다."></textarea>
                    </div>
                </div>
                <div class="form-row">
                ...
                <div class="form-row">
                    <div class="form-group col col-md-12">
                        ...
                        <table id="" class="table table-bordered no-footer m-0" role="grid"
                            ...
                            <tbody id="asset_reservation_items_list">
...
<script>
    ...
    pageLoad("asset_reservation_list", {page_num: 1, filter1: 100, filter2: 1}, "자산 예약 보드", "asset_reservation_list");
    ...
    $('input[name="btn-radio-status"]').click(function () {
        ...
        pageLoad("asset_reservation_list", param, "자산 예약 보드", "asset_reservation_list");
    })
