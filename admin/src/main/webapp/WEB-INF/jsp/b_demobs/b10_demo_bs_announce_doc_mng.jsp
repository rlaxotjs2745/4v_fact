    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-sm-6 col-xl-3">
                <div class="card">
                    <button id="btn_filter1" class="btn btn-white" onclick="javascript:pageLoad('b10_demo_bs_announce_doc_mng',{page_num:1, filter1:9999, filter2:9998},'사업공고문 관리');">
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="card">
                    <button id="btn_filter2" class="btn btn-white" onclick="javascript:pageLoad('b10_demo_bs_announce_doc_mng',{page_num:1,filter1:3,filter2:9998},'사업공고문 관리');">
                        <div class="d-flex align-items-center">
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="card">
                    <button id="btn_filter3" class="btn btn-white" onclick="javascript:pageLoad('b10_demo_bs_announce_doc_mng',{page_num:1,filter1:1,filter2:2},'사업공고문 관리');">
                        <div class="d-flex align-items-center">
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="card">
                    <button id="btn_filter4" class="btn btn-white" onclick="javascript:pageLoad('b10_demo_bs_announce_doc_mng',{page_num:1,filter1:4,filter2:9998},'사업공고문 관리');">
                        <div class="d-flex align-items-center">
