...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <h5 class="d-flex justify-content-between align-items-center w-100 mt-2">
        <div><i class="pe-7s-box1 text-success-custom"></i> 실증사업 수행관리</div>
    </h5>
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item"><button id="btn_tab_getinfo" class="nav-link active">사업 관리</button></li>
        <li class="nav-item"><button id="btn_tab_appl" class="nav-link">위탁기업 관리</button></li>
        <li class="nav-item"><button id="btn_tab_eval" class="nav-link">자율기업 관리 </button></li>
        <li class="nav-item"><button id="btn_tab_contract" class="nav-link">이용료 관리</button></li>
    </ul>
