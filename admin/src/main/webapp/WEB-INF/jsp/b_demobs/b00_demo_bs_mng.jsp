    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="card px-4 pt-2 mb-2 bg-">
            <div class="form-row mb-4">
                ...
                <div class="col-md-5 ">
                    <label class="form-label text-body">승인 상태</label>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="table_demo_bs" class="table table-striped table-bordered dataTable no-footer mt-0" role="grid" aria-describedby="article-list_info" style="">
                                ...
                                <tr role="row">
                                    <th class="text-center" style="width:10%">사업 상태</th>
                                    <th class="text-center" style="width:18%">사업 번호</th>
                                    <th class="text-center" style="width:36%">사업 제목</th>
                                    <th class="text-center" style="width:8%">모집 수</th>
                                    <th class="text-center" style="width:10%">사업 시작일시</th>
                                    <th class="text-center" style="width:10%">사업 종료일시</th>
                                    <th class="text-center" style="width:8%">게시여부</th>
                                </tr>
                                </thead>
                                <tbody>
                            <c:choose>
                                ...
                                <c:forEach var = "i" begin = "1" end = "4">
                                    ...
                                    <tr><td class="text-center empty" colspan="7"></td></tr>
                                    </c:forEach>
...
<c:if test="${total_count ne 0}">
                    <div class="row">
                        <div class="col-sm-12 col-md-5">
                            <div class="text-body" id="article-list_info" role="status" aria-live="polite">총 ${total_count}개 중 ${list_amount*(cur_page-1)+1}에서 ${list_amount*page_amount}까지</div>
                        </div>
                        <div class="col-sm-12 col-md-7">
                            <div class="dataTables_paginate paging_simple_numbers" id="article-list_paginate">
                                <ul class="pagination">
                                    ...
                                    <c:if test="${is_past eq true}"><li class="paginate_button page-item previous"><a href="javascript:pageLoad('b00_demo_bs_mng',{page_num:1,filter1:'${filter1}', filter2:'${filter2}'},'사업공고문 관리');" aria-controls="article-list" data-dt-idx="0" tabindex="0" class="page-link"><i class="fas fa-angle-double-left d-block"></i></a></li></c:if>
                                    <c:if test="${is_prev eq true}"><li class="paginate_button page-item previous"><a href="javascript:pageLoad('b00_demo_bs_mng',{page_num:'${cur_page-1}',filter1:'${filter1}',filter2:'${filter2}'},'사업공고문 관리');" aria-controls="article-list" data-dt-idx="0" tabindex="0" class="page-link"><i class="fas fa-angle-left d-block"></i></a></li></c:if>



                                    <c:forEach var="i" begin="1" end="${page_amount}">
                                        <li class="paginate_button page-item <c:if test="${(cur_sector-1)*page_amount+i eq cur_page}">active</c:if>"><a href="javascript:pageLoad('b00_demo_bs_mng',{page_num:'${(cur_sector-1)*page_amount+i}',filter1:'${filter1}',filter2:'${filter2}'},'사업공고문 관리');" class="page-link">${(cur_sector-1)*page_amount+i}</a></li>
                                    </c:forEach>

                                    <c:if test="${is_next eq true}"><li class="paginate_button page-item next"><a href="javascript:pageLoad('b00_demo_bs_mng',{page_num:'${cur_page+1}',filter1:'${filter1}',filter2:'${filter2}'},'사업공고문 관리');" aria-controls="article-list" data-dt-idx="6" tabindex="0" class="page-link"><i class="fas fa-angle-right d-block"></i></a></li></c:if>
                                    <c:if test="${is_last eq true}"><li class="paginate_button page-item next"><a href="javascript:pageLoad('b00_demo_bs_mng',{page_num:'${tot_page}',filter1:'${filter1}',filter2:'${filter2}'},'사업공고문 관리');" aria-controls="article-list" data-dt-idx="6" tabindex="0" class="page-link"><i class="fas fa-angle-double-right d-block"></i></a></li></c:if>
                                </ul>
                            </div>
                        </div>
...
<%--        <div class="d-flex justify-content-end align-items-end w-100 mt-2">
    ...
    <%--                            <label class="col-form-label col-form-label-md col-md-2 text-md-right font-weight-bold mode-edit mode-new">게시여부</label>--%>
                            ...
                            <div class="form-row border-bottom boder-success">
                                ...
                                <div class="col-md-2 mode-edit">
                                    <button type="button" class="btn btn-outline-primary" id="is_confirm">승인하기</button>
                                </div>
