...
<script>
    ...
    $(".page-link").click(function (){
        if($(this).attr("id") == "article-list_next-one_btn"){
            pageLoad('admin_corporate',{cur_page: '${adminList[0].page + 1}', corp: parseInt(curCategory)},'대시보드', "admin");
        } else if($(this).attr("id") == "article-list_next_btn"){
            pageLoad('admin_corporate',{cur_page: '${adminList[0].maxvalue}', corp: parseInt(curCategory)},'대시보드', "admin");
        } else if($(this).attr("id") == "article-list_previous_btn"){
            pageLoad('admin_corporate',{cur_page:1, corp: parseInt(curCategory)},'대시보드', "admin");
        } else if($(this).attr("id") == "article-list_previous-one_btn"){
            pageLoad('admin_corporate',{cur_page: '${adminList[0].page - 1}', corp: parseInt(curCategory)},'대시보드', "admin");
        }
    })

    // pageLoad("admin_corporate", {cur_page: 1, corp: 100}, "어드민 보드", true);
</script>
<!-- / Layout footer -->
